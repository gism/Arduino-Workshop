...
void setup() {
  ...
  display.println("Mision Imposible");
...
void loop() {
  ...
  display.drawRect(24, 15, 104, 20, WHITE);
  
  int xFill = map(valMicCor, 0, 100, 0, 104);
  display.fillRect(24, 15, xFill, 20, WHITE);
  
  display.setCursor(3,20);
  display.println(valMicCor);
